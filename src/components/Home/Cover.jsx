    ...
    <div className="cover-container-background">
      <div className=" container cover-container">
        <div className="text-cover">
          <h1 className="slogan-cover">
            Conéctate de Forma Digital con Tarjetag
          </h1>
          <p className="paragraph-slogan-cover">
            Crea tarjetas de presentación irresistibles que te abran puertas y
        ...
        <div className="cover-sub-container">
          ...
          <Spline
            scene={
              "https://draft.spline.design/mTewcjp1QDLvHqoq/scene.splinecode"
            }
            className="spline-cover-one"
          />
        </div>
      </div>
    </div>
